...
def compute_stats(file_path: str, total_problems: int):
    ...
    return {
        ...
        "pass_1_rel": num_pass_1 / total_problems,
        "pass_2_abs": num_pass_2,
        "pass_2_rel": num_pass_2 / total_problems,
        "pass_3_abs": num_pass_3,
        "pass_3_rel": num_pass_3 / total_problems,
...
def process_models(models):
    ...
    for model in models:
        ...
        results[model] = compute_stats(file_path, 4)
